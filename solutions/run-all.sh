...
echo -n "."
ANGR_OUT_01="$(python3 01_angr_avoid/solve01.py 01_angr_avoid/01_angr_avoid 2> /dev/null)"
echo -n "."
...
echo -n "."
ANGR_OUT_04="$(python3 04_angr_symbolic_stack/solve04.py 04_angr_symbolic_stack/04_angr_symbolic_stack 2> /dev/null)"
echo -n "."
ANGR_OUT_05="$(python3 05_angr_symbolic_memory/solve05.py 05_angr_symbolic_memory/05_angr_symbolic_memory 2> /dev/null)"
echo -n "."
...
echo -n "."
ANGR_OUT_14="$(python3 14_angr_shared_library/solve14.py 14_angr_shared_library/lib14_angr_shared_library.so 2> /dev/null)"
echo -n "."
ANGR_OUT_15="$(python3 15_angr_arbitrary_read/solve15.py 15_angr_arbitrary_read/15_angr_arbitrary_read 2> /dev/null)"
echo -n "."
ANGR_OUT_16="$(python3 16_angr_arbitrary_write/solve16.py 16_angr_arbitrary_write/16_angr_arbitrary_write 2> /dev/null)"
echo -n "."
ANGR_OUT_17="$(python3 17_angr_arbitrary_jump/solve17.py 17_angr_arbitrary_jump/17_angr_arbitrary_jump 2> /dev/null)"
echo -n "."
echo ""
echo "-- Solutions --"
echo "00: $ANGR_OUT_00"
