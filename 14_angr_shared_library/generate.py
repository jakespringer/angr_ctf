...
def generate(argv):
  ...
  with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '14_angr_shared_library_so.c.templite'), 'r') as temp_file:
  ...
  with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), '14_angr_shared_library.c.templite'), 'r') as temp_file:
    template = temp_file.read()
